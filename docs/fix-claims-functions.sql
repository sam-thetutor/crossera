...
-- This updates the existing functions to use the correct table structure

-- 1. Fix get_campaign_claims_data function
...
-- 2. Fix get_user_claims_history function
...
-- 3. Fix get_user_total_rewards function
...
-- 4. Grant permissions (if not already granted)
